...
cargo fmt --all -- --check
# `sim` gates the triblespace-net simulation integration binaries behind
# `#![cfg(feature = "sim")]`. No crate in the workspace enables it, so a bare
# `cargo test` compiled them EMPTY and printed "test result: ok" with 0 passed /
# 0 failed; the gate was green because it was empty. Found 2026-08-21.
#
