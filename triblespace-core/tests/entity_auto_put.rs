...
//! calls `to_encoded` for every field, getting back a
//! `Encoded<S>`; for `Encoded::Blob` variants the bytes get absorbed
...
mod ns {
    use triblespace_core::prelude::*;
    attributes! {
        "DD00000000000000DD00000000000020" unsafe as pub note: inlineencodings::Handle<blobencodings::UTF8String>;
    }
}
