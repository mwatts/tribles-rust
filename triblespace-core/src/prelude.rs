...
pub use crate::collection::{
    ...
    FactCover, FactSnapshot, MappingEvidence, MappingEvidenceSelector, MappingEvidenceStore,
    MappingHandle, SimpleArchiveCollection, Snapshot, TryFromCover, VerifyingKey,
};
