...
//! selections and their non-zero slices stay allocation-free; a
...
impl<'a> RowSelection<'a> {
    ...
    ///
    /// A consecutive slice remains consecutive with its first ordinal shifted;
    /// an explicit slice remains a borrowed subslice.
    ///
    /// # Panics
    ///
