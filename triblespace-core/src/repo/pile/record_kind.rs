...
record_kinds! {
    ...
    CollectionGossipRecordV1 = KIND_ID_COLLECTION_GOSSIP "9BB5B1F4D6FD8FB850B494C2CF51B5CA",
        ...
        "pile-collection-gossip-v1",
        "An author-signed, irrevocable permission to redistribute that author's strictly verified commits in one exact collection. Envelope bytes 64..96 hold the collection descriptor handle, 96..128 the author Ed25519 public key, 128..160 the signature R component, 160..192 the signature S component, and 192..256 are zeros. A grant retains no blob and does not require its collection to be resident.";
}
